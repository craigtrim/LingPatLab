...
class TestExtractPeople(unittest.TestCase):
    ...
    def test_service(self):
        sentence = Sentence([
            ...
            SpacyResult(
                id='9583229153074933549#129', text='Test ', tense='', noun_number='singular',
                verb_form='', sentiment=0.0, pos='PROPN', tag='NNP', dep='pobj', ent='',
                shape='XxXxxxx', is_alpha=True, is_stop=False, head='18194338103975822726#124',
                is_punct=False, x=471, y=479, is_wordnet=False, normal='test', stem='test',
                other={
                    'i': 128, 'idx': 538, 'orth': 9583229153074933549, 'head_i': 124, 'head_idx': 523,
                    'head_orth': 18194338103975822726, 'head_text': 'like'
                }),
        ...
        #     'Spencer': ['Test Spencer', 'McMorris Test Spencer', 'Admiral McMorris Test Spencer'],
        #     'Test': ['McMorris Test', 'Admiral McMorris Test'],
        #     'McMorris': ['Admiral McMorris']
        # })

        self.assertEqual(results, {
            'Spencer': ['Test Spencer', 'McMorris Test Spencer'],
            'McMorris': ['Admiral McMorris']
        })
